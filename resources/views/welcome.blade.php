...
<div id="wrapper">
    ...
    <section class="featured portfolio bg-white-2 rec-pro">
        <div class="container-fluid">
            <div class="sec-title">
                <h2><span>Shrimp Ready</span>Stock</h2>
            ...
            <div class="portfolio col-xl-12">
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-item active">
                        <div class="col-md-6">
                        <img class="d-block w-100" src="https://i.ibb.co/HXcLC2G/g4.jpg" alt="1 slide">
                        </div>
                        <div class="col-md-6">
                        <h2><span>Piagam Penghargaan</span> </h2>
                        <br>
                        <h4 style="text-align: left"> Piagam Penghargaan dari Kepala KPP Pratama Kabupaten Banyuwangi Tahun 2020.
                            <br>
                            <br>
                            Dipersembahkan Kepada PT. Pasar Dunia Seafood Sebagai Wajib Pajak Yang Telah Memberikan Kontribusi Terbaik Untuk Negara.</h4>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="col-md-6">
                            ...
                            <h4> Sertifikat Penghargaan Dari FUSO PT. Krama Yudha Tiga Berlian Motors.
                                ...
                                <br>
                                Sebagai Pelanggan Setia Mitsubushi Fuso Selama 50 Tahun Dan Juga Berkontribusi Untuk Kemajuan Indonesia. </h4>
                        </div>
                        <div class="col-md-6">
                        <img class="d-block w-100" src="https://i.ibb.co/pzNVxmW/g1.jpg" alt="2 slide">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="col-md-6">
                        <img class="d-block w-100" src="https://i.ibb.co/CbzBPf2/g3.jpg" alt="3 slide">
                        </div>
                        <div class="col-md-6">
                        <h2><span>Piagam Penghargaan</span> </h2>
                        <br>
                        <h4> Piala Penghargaan Dari FUSO PT. Krama Yudha Tiga Berlian Motors.
                            <br>
                            <br>
                            Dipersembahkan Kepada PT. Pasar Dunia Seafood Sebagai "Profesional Business Partner" Dan Best Customers FUSO PT. Krama Yudha Tiga Berlian Motors Pada tahun 2019. </h4>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                        <img class="d-block w-100" src="https://i.ibb.co/9GbHfNK/g2.jpg" alt="4 slide">
                        </div>
                    </div>
                   <div class="carousel-item">
                        <div class="col-md-6">
                        <img class="d-block w-100" src="https://i.ibb.co/vJXYrTm/g5.jpg" alt="5 slide">
                        </div>
                        <div class="col-md-6">
                        <h2><span>Piagam Penghargaan</span> </h2>
                        <br>
                        <h4> Piala Penghargaan Dari FUSO PT. Krama Yudha Tiga Berlian Motors Dan PT. Dipo Internasional Pahala Otomotif.
                            <br>
                            <br>
                            Dipersembahkan Kepada PT. Pasar Dunia Seafood. Sebagai" Profesional Business Partner" Dan Best Customers FUSO PT. Krama Yudha Tiga Berlian Motors
                            <br>
                            Pada tahun 2018Dan Sebagai Best Driver Mitsubishi Fuso Gathering 2019. </h4>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-6">
                        <div class="netabout">
                            <div class="logo" style="color: aliceblue">
                                <img src="https://i.ibb.co/6gfnbG4/rmbg.png" style="height:70px; width:70px" alt="netcom">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="newsletters">
                            ...
                            <iframe class="text-center mt-5" style="style=border:0;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3948.0673527790127!2d114.30565011365839!3d-8.296096394031286!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd150c7d65272f5%3A0xb63b0621a0d5b753!2sPT.%20Pasar%20Dunia%20Seafood!5e0!3m2!1sid!2sid!4v1641306943202!5m2!1sid!2sid" allowfullscreen="" loading="lazy"></iframe>
                        </div>
                    </div>
                </div>
            </div>
